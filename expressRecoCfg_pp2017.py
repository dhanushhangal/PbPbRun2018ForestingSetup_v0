...
# with command line options: step2 --conditions 92X_dataRun2_Express_v8 -s RAW2DIGI,L1Reco,RECO --process RECO --data --era Run2_2017_ppRef --eventcontent AOD --runUnscheduled --scenario pp --datatier AOD
